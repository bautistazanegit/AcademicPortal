...
<head>
    ...
    <title>Select Student - Grades | NEXUS</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="designs_admin/dashboard.css">
    <link rel="stylesheet" href="designs_admin/grade_select_student.css">
</head>
<body>
        ...
        <div class="container">
            <div class="header">
                <div>
                    ...
                    <p>Select a student to encode or view their subject grades.</p>
                </div>
            ...
            <table class="styled-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="course-tag"><?= htmlspecialchars($row['course']) ?></span>
                            <span class="section-text"><?= $row['year'] ?>-<?= $row['block'] ?></span>
                        </td>
                        <td style="text-align: center;">
                            <a href="grade_select_subject.php?student_id=<?= $row['id'] ?>" class="btn-select">
                                View Subjects <i class="fas fa-chevron-right"></i>
                            </a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
